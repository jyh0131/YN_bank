...
<body>
	<div id="container">
		...
		<form action="/emp/empAdd.do" method="post" enctype="multipart/form-data">
			
			<div id="profile">
				<h2>프로필</h2>
				<div id="profileMain">
					<div id="pic">
						<img alt="사원사진" src="${pageContext.request.contextPath}/images/staff1.jpg"> 
				...
				<div id="profileEdit">
					<table>
						...
						<tr>
							<th>직책</th>
							<td><input type="text" name="empTitle"></td>
						</tr>
						<tr>
							<th>권한</th>
							<td><input type="text" name="empAuth"></td>
						</tr>
						<tr>
							<th>월급</th>
